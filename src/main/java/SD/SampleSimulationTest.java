...
import SD.hsbo.fbg.systemdynamics.model.Model;
...
public class SampleSimulationTest {
    ...
    public void simulationRunTest() {
        ...
        try {
            ...
            // Create prey birthrate and deathrate as variable
            Variable expansionRatePredator = (Variable) model.createModelEntity(ModelEntityType.VARIABLE, BIRTH_RATE_PREDATOR_KEY);
