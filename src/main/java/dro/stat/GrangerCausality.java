...
//            print(laggedH0);
	        ...
	        double[] RegressionH1=h1.estimateRegressionParameters();
//            print(laggedH1);
...
//	        double ftest = ((RSS0 - RSS1)/this.lagSize) / (RSS1 / (laggedH0Rows - 2*this.lagSize - 1));
			double ftest = ((RSS0 - RSS1)/nbrParametersModel0) / (RSS1 / (laggedH0Rows - nbrParametersModel1 - 1));
...
//	        System.out.println("P-value " + pValue);
	        GrangerCausalIndicator grangerCausalIndicator=new GrangerCausalIndicator(pValue, CRITICAL_VALUE, this.lagSize,RegressionH1);
	        return grangerCausalIndicator;
